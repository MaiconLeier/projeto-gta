...
botao.addEventListener("click", () => {
    ...
    devemos remover a classe ativo pra que ele esconda o conteúdo novamente
    if(botaoEstaAberto) {
        elementoPlataformas.classList.remove("ativo");
    }else{
        Passo 4 - quando o usuário clicar, adicionar a classe ativo na listagem de plataformas 
    dentro do botão pra que o conteúdo apareça
